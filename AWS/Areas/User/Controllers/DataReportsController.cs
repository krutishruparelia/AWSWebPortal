...
namespace AWS.Areas.User.Controllers
{
    public class DataReportsController : Controller
    {
        ...
        public JsonResult ReportGetData(string toDate, string fromDate, string stationName)
        {
            string json = "";
            ...
            var reportSql = "Select StationID,Date,Time," + ReportcolumnName.TrimEnd(',') + " from " + tablename + "   where date between '" + fromDateString + "' and '" + toDateString + "' order by Date,Time";
