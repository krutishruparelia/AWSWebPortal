...
! function (o) {
    var a = o(window),
        n = o("body");
    feather.replace(), o.createOverlay = function () {
        o(".overlay").length < 1 && (n.addClass("no-scroll").append('<div class="overlay"></div>'), o(".overlay").addClass("show"))
    }, n.hasClass("layout-container") && o(".container-fluid").addClass("container").removeClass("container-fluid"), a.on("load", function () {
        o("body").hasClass("layout-container") ? o(".side-menu .side-menu-body").wrap('<div class="container"></div>') : o(".side-menu .side-menu-body").wrap('<div class="container-fluid"></div>'), o(".page-loader").fadeOut(700, function () {
            //setTimeout(function () {
            //    toastr.options = {
            //        timeOut: 3e3,
            //        progressBar: !0,
            ...
            //        showDuration: 200,
            //        hideDuration: 200
            //    }, toastr.success("Welcome! AWS Admin.")
            //}, 1e3)
        })
    }), a.on("load", function () {
        setTimeout(function () {
            o(".side-menu .side-menu-body ul li a").each(function () {
                var e = o(this);
                e.next("ul").length && (e.append('<i class="sub-menu-arrow ti-angle-right"></i>'), n.hasClass("horizontal-side-menu") && o(".side-menu .side-menu-body > ul > li > a > .sub-menu-arrow").removeClass("ti-angle-right").addClass("ti-angle-down"))
            })
        }, 200)
        ...
        (!o(e.target).is(".sidebar, .sidebar *, .sidebar-open, .sidebar-open *") && o(".sidebar").hasClass("show") || !o(e.target).is(".search-panel-open, .search-panel-open *, nav.navbar .header-body form.search, nav.navbar .header-body form.search *") && o("nav.navbar .header-body form.search").hasClass("show") || !o(e.target).is(".side-menu-open, .side-menu-open *, .side-menu, .side-menu *") && o(".side-menu").hasClass("show")) && (o(".sidebar").removeClass("show"), o("nav.navbar .header-body form.search").removeClass("show"), o(".side-menu").removeClass("show"), n.removeClass("no-scroll"), o(".overlay").remove())
    ...
    function s() {
        a.width() < 768 ? o(".table-responsive-stack").each(function (e) {
    ...
    }), s(), d(), window.onresize = function (e) {
        s(), d("resize")
    ...
    var t, i = o(".table-responsive");

    function d(e) {
        "resize" == (e = e || "") ? (768 <= a.width() && o(".card-scroll").getNiceScroll().resize(), (!n.hasClass("horizontal-side-menu") && 992 <= a.width() || n.hasClass("horizontal-side-menu") && a.width() < 992) && 768 <= a.width() && o(".side-menu>div>ul").getNiceScroll().resize(), o(".card").each(function () {
            if (768 <= a.width()) {
        ...
        }), 768 <= a.width() && (o(".chat-app .chat-sidebar .chat-sidebar-messages")[0] && o(".chat-app .chat-sidebar .chat-sidebar-messages").getNiceScroll().resize(), o(".chat-app .chat-body .chat-body-messages")[0] && o(".chat-app .chat-body .chat-body-messages").getNiceScroll().resize())) : (768 <= a.width() && (o(".card-scroll").niceScroll(), o(".table-responsive").niceScroll()), (!n.hasClass("horizontal-side-menu") && 992 <= a.width() || n.hasClass("horizontal-side-menu") && a.width() < 992) && a.on("load", function () {
        ...
        }), 768 <= a.width() && (o(".chat-app .chat-sidebar .chat-sidebar-messages")[0] && o(".chat-app .chat-sidebar .chat-sidebar-messages").scrollTop(o(".chat-app .chat-sidebar .chat-sidebar-messages").get(0).scrollHeight, -1).niceScroll(), o(".chat-app .chat-body .chat-body-messages")[0] && o(".chat-app .chat-body .chat-body-messages").scrollTop(o(".chat-app .chat-body .chat-body-messages").get(0).scrollHeight, -1).niceScroll()))
    }
    if (i.on("show.bs.dropdown", function (e) {
        ...
        t.css({
            display: "block",
            top: a.top + o(e.target).outerHeight(),
            left: a.left,
            width: "184px",
            "font-size": "14px"
        ...
        o(e.target).is(".chat-app-wrapper .chat-sidebar, .chat-app-wrapper .chat-sidebar *, .chat-app-wrapper .btn-chat-sidebar-open, .chat-app-wrapper .btn-chat-sidebar-open *") || o(".chat-app-wrapper .chat-sidebar").removeClass("chat-sidebar-opened")
    }), o(document).on("click", ".side-menu ul li a", function () {
        var e = o(this);
        if (e.next("ul").length) return e.find(".sub-menu-arrow").toggleClass("rotate-in"), e.next("ul").toggle(200), e.parent("li").siblings().find("ul").not(e.parent("li").find("ul")).hide(), e.next("ul").find("li ul").hide(), !n.hasClass("horizontal-side-menu") && !n.hasClass("icon-side-menu") && 768 <= a.width() && setTimeout(function () {
            o(".side-menu>.side-menu-body>ul").getNiceScroll().resize()
        }, 300), !1
    }), o("body.icon-side-menu .side-menu").hover(function (e) { }, function (e) {
    ...
    }), o('[data-toggle="tooltip"]').tooltip(), o('[data-toggle="popover"]').popover(), o(".carousel").carousel(), a.scroll(function () {
        o('nav.navbar .dropdown.show [data-toggle="dropdown"]').trigger("click")
    }), n.hasClass("icon-side-menu") && o(".side-menu").hover(function (e) {
